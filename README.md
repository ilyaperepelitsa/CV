...
that I did when I was going through rough times. I can be extremely formal at ti
...
heavily on React + Django with Django REST in the middle. Using PostgreSQL on
RDS.
