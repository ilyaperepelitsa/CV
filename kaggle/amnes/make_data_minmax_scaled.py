...
pd.DataFrame(x_train).to_csv(os.path.join(
                            os.path.dirname(
                                    os.path.abspath("__file__")
                            ),'ames/data/working/minmax_train_x.csv'
                        ), index = False)
pd.DataFrame(x_test).to_csv(os.path.join(
                            os.path.dirname(
                                    os.path.abspath("__file__")
                            ),'ames/data/working/minmax_test_x.csv'
                        ), index = False)

pd.DataFrame(y_train).to_csv(os.path.join(
                            os.path.dirname(
                                    os.path.abspath("__file__")
                            ),'ames/data/working/minmax_train_y.csv'
                        ))

pd.DataFrame(y_test).to_csv(os.path.join(
                            os.path.dirname(
                                    os.path.abspath("__file__")
                            ),'ames/data/working/minmax_test_y.csv'
                        ))
...
pd.DataFrame(test_data_ready).set_index(test_data.index).to_csv(os.path.join(
                            os.path.dirname(
                                    os.path.abspath("__file__")
                            ),'ames/data/working/minmax_target_x.csv'
                        ))
