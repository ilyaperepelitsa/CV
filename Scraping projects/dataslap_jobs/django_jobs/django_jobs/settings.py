...
JSON_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "credentials", "passwords.json")
...
SECRET_KEY = '4xj0gjvnb+i2(og4yvxf$53f7yed7i#9@izi@u=a@c=+esp*@_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'job_search',
        'USER': dataslap_postgres["username"],
